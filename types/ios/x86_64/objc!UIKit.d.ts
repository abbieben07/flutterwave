...
declare class UIBezierPath extends NSObject implements NSCopying, NSSecureCoding {
	...
	mdc_addBottomLeftCornerFromPointToPointWithRadius(point1: CGPoint, point2: CGPoint, radius: number): void;

	mdc_addBottomRightCornerFromPointToPointWithRadius(point1: CGPoint, point2: CGPoint, radius: number): void;

	mdc_addTopLeftCornerFromPointToPointWithRadius(point1: CGPoint, point2: CGPoint, radius: number): void;

	mdc_addTopRightCornerFromPointToPointWithRadius(point1: CGPoint, point2: CGPoint, radius: number): void;
...
declare class UIImage extends NSObject implements NSItemProviderReading, NSItemProviderWriting, NSSecureCoding, UIAccessibilityIdentification, UIItemProviderPresentationSizeProviding {
	...
	static keyboardDownImage(): UIImage;

	static keyboardLeftImage(): UIImage;

	static keyboardNextImage(): UIImage;

	static keyboardPreviousImage(): UIImage;

	static keyboardRightImage(): UIImage;

	static keyboardUpImage(): UIImage;
...
declare class UIScrollView extends UIView implements NSCoding, UIFocusItemScrollableContainer {
	...
	shouldIgnoreContentInsetAdjustment: boolean;

	shouldIgnoreScrollingAdjustment: boolean;

	shouldRestoreScrollViewContentOffset: boolean;
...
declare class UIView extends UIResponder implements CALayerDelegate, NSCoding, UIAccessibilityIdentification, UIAppearance, UIAppearanceContainer, UICoordinateSpace, UIDynamicItem, UIFocusItem, UIFocusItemContainer, UILargeContentViewerItem, UITraitEnvironment {
	...
	ignoreSwitchingByNextPrevious: boolean;
	...
	readonly keyboardToolbar: IQToolbar;
	...
	shouldHideToolbarPlaceholder: boolean;

	shouldResignOnTouchOutsideMode: IQEnableMode;
	...
	addCancelDoneOnKeyboardWithTargetCancelActionDoneActionShouldShowPlaceholder(target: any, cancelAction: string, doneAction: string, shouldShowPlaceholder: boolean): void;

	addCancelDoneOnKeyboardWithTargetCancelActionDoneActionTitleText(target: any, cancelAction: string, doneAction: string, titleText: string): void;
	...
	addDoneOnKeyboardWithTargetActionShouldShowPlaceholder(target: any, action: string, shouldShowPlaceholder: boolean): void;

	addDoneOnKeyboardWithTargetActionTitleText(target: any, action: string, titleText: string): void;

	addGestureRecognizer(gestureRecognizer: UIGestureRecognizer): void;

	addInteraction(interaction: UIInteraction): void;

	addKeyboardToolbarWithTargetWithTargetTitleTextRightBarButtonConfigurationPreviousBarButtonConfigurationNextBarButtonConfiguration(target: any, titleText: string, rightBarButtonConfiguration: IQBarButtonItemConfiguration, previousBarButtonConfiguration: IQBarButtonItemConfiguration, nextBarButtonConfiguration: IQBarButtonItemConfiguration): void;

	addLayoutGuide(layoutGuide: UILayoutGuide): void;

	addMotionEffect(effect: UIMotionEffect): void;

	addPreviousNextDoneOnKeyboardWithTargetPreviousActionNextActionDoneActionShouldShowPlaceholder(target: any, previousAction: string, nextAction: string, doneAction: string, shouldShowPlaceholder: boolean): void;

	addPreviousNextDoneOnKeyboardWithTargetPreviousActionNextActionDoneActionTitleText(target: any, previousAction: string, nextAction: string, doneAction: string, titleText: string): void;

	addPreviousNextRightOnKeyboardWithTargetRightButtonImagePreviousActionNextActionRightButtonActionShouldShowPlaceholder(target: any, rightButtonImage: UIImage, previousAction: string, nextAction: string, rightButtonAction: string, shouldShowPlaceholder: boolean): void;

	addPreviousNextRightOnKeyboardWithTargetRightButtonImagePreviousActionNextActionRightButtonActionTitleText(target: any, rightButtonImage: UIImage, previousAction: string, nextAction: string, rightButtonAction: string, titleText: string): void;

	addPreviousNextRightOnKeyboardWithTargetRightButtonTitlePreviousActionNextActionRightButtonActionShouldShowPlaceholder(target: any, rightButtonTitle: string, previousAction: string, nextAction: string, rightButtonAction: string, shouldShowPlaceholder: boolean): void;

	addPreviousNextRightOnKeyboardWithTargetRightButtonTitlePreviousActionNextActionRightButtonActionTitleText(target: any, rightButtonTitle: string, previousAction: string, nextAction: string, rightButtonAction: string, titleText: string): void;

	addRightButtonOnKeyboardWithImageTargetActionShouldShowPlaceholder(image: UIImage, target: any, action: string, shouldShowPlaceholder: boolean): void;

	addRightButtonOnKeyboardWithImageTargetActionTitleText(image: UIImage, target: any, action: string, titleText: string): void;

	addRightButtonOnKeyboardWithTextTargetActionShouldShowPlaceholder(text: string, target: any, action: string, shouldShowPlaceholder: boolean): void;

	addRightButtonOnKeyboardWithTextTargetActionTitleText(text: string, target: any, action: string, titleText: string): void;

	addRightLeftOnKeyboardWithTargetLeftButtonImageRightButtonImageLeftButtonActionRightButtonActionShouldShowPlaceholder(target: any, leftButtonImage: UIImage, rightButtonImage: UIImage, leftButtonAction: string, rightButtonAction: string, shouldShowPlaceholder: boolean): void;

	addRightLeftOnKeyboardWithTargetLeftButtonImageRightButtonImageLeftButtonActionRightButtonActionTitleText(target: any, leftButtonImage: UIImage, rightButtonImage: UIImage, leftButtonAction: string, rightButtonAction: string, titleText: string): void;

	addRightLeftOnKeyboardWithTargetLeftButtonTitleRightButtonTitleLeftButtonActionRightButtonActionShouldShowPlaceholder(target: any, leftButtonTitle: string, rightButtonTitle: string, leftButtonAction: string, rightButtonAction: string, shouldShowPlaceholder: boolean): void;

	addRightLeftOnKeyboardWithTargetLeftButtonTitleRightButtonTitleLeftButtonActionRightButtonActionTitleText(target: any, leftButtonTitle: string, rightButtonTitle: string, leftButtonAction: string, rightButtonAction: string, titleText: string): void;
	...
	parentContainerViewController(): UIViewController;
	...
	superviewOfClassTypeBelowView(classType: typeof NSObject, belowView: UIView): UIView;
	...
	topMostController(): UIViewController;
	...
	viewContainingController(): UIViewController;
...
declare class UIViewController extends UIResponder implements NSCoding, NSExtensionRequestHandling, UIAppearanceContainer, UIContentContainer, UIFocusEnvironment, UIStateRestoring, UITraitEnvironment {
	...
	IQLayoutGuideConstraint: NSLayoutConstraint;
	...
	parentIQContainerViewController(): UIViewController;
